...
public class audio_recorder extends Fragment {

    private static final String TAG = audio_recorder.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textView = v.findViewById(R.id.txtViewRecord);
